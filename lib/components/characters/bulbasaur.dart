...
class Bulbasaur extends Player {
  ...
  FutureOr<void> loadAllAnimations() async {
    ...
    idleAnimation = idlespriteSheet.createAnimation(
        row: 0, stepTime: animationSpeed, to: 3);
    ...
    runUpAnimation = runningspriteSheet.createAnimation(
        row: 4, stepTime: animationSpeed, to: 6);
